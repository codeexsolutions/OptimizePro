...
| **Disparo** | Manda mensagem no WhatsApp para uma lista. | `app.js`, `server.js` |
...
|---|---|
| `server.js` | Express, Socket.IO e a conexão do WhatsApp |
...
| `config.js` | Valores de partida do disparo |
